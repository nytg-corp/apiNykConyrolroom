<?php
    ...
    $sql= "INSERT INTO CONTROL_HIS_PRE_WAREHOUSE
    SELECT M.* FROM CONTROL_PRE_WAREHOUSE M ";          
...
//             
  ...
  curl_setopt( $chOne, CURLOPT_POSTFIELDS, 'message='.'Interface History Pre W/H Control Room NYK');
