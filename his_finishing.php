<?php
  ...
  $conn_omnoi = oci_connect("DEMO", "DEMO", $dbstr_omnoi,'UTF8'); //AL32UTF8
    ...
    $sql= "INSERT INTO CONTROL_HIS_FINISHING
    SELECT M.* FROM CONTROL_FINISHING M ";          
...
//             
  ...
  curl_setopt( $chOne, CURLOPT_POSTFIELDS, 'message='.'Interface History Finishing Control Room NYK');
