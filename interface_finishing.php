<?php
	...
	$queryDelete = oci_parse($conn_omnoi, "delete from CONTROL_FINISHING");

	oci_execute($queryDelete);

	$sqlTime = "SELECT m.* FROM CONTROL_SET_TIME m WHERE PROCESS = 'FINISHING' AND OU_CODE = 'D03'";
    ...
    $sql = "INSERT INTO CONTROL_FINISHING
...
// 	}
	...
	// curl_setopt( $chOne, CURLOPT_POSTFIELDS, 'message='.'Interface Finishing Control Room NYK');
